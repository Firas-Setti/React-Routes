...
export default function Filtring({filter}) {
    ...
    return (
        <form className="searchform" onChange={submitted} onSubmit={submitted}>
            <h4> FIRAS MOVIES </h4>
            <input ref={searchRef} className="form-control form-control-lg searchinp" type="text" placeholder="                       Search for your favorite anime movie..." aria-label=".form-control-lg example" />
